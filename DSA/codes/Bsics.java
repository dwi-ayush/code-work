...
public class Bsics{
    public static void main(String[] args) {
        ...
        if(number<=0){
            ...
            System.out.println("it is not the power of four ");
        }
        if(number % 4 == 0){
           while(pow == 1){
            pow = (number/4);
           
            System.out.println("its is a power of four");
            ...
            System.out.println("it is divided by 4 but not the power of four ");
           }
        scn.close();
    }
}
